...
-- NOTE: use INSERT IGNORE so existing rows (same primary key/unique) are not duplicated
SET FOREIGN_KEY_CHECKS=0;

-- entreprise
INSERT IGNORE INTO `entreprise` (`entreprise_id`, `entreprise_adresse`, `info_acces_locaux`, `raison_sociale`) VALUES
...
-- majeur
INSERT IGNORE INTO `majeur` (`majeur_id`, `label`) VALUES
(1, 'Cybersécurité'),
(2, 'IA & Data'),
(3, 'Développement Web'),
...
-- poste
INSERT IGNORE INTO `poste` (`poste_id`, `label`) VALUES
...
INSERT IGNORE INTO `maitre_apprentissage` (`ma_id`, `ma_email`, `ma_nom`, `ma_prenom`, `ma_remarque`, `ma_telephone`, `password`, `poste_id`) VALUES
...
INSERT IGNORE INTO `user` (`dtype`, `id`, `email`, `nom`, `password`, `prenom`) VALUES
...
INSERT IGNORE INTO `apprenti` (`apprenti_id`, `annee_academique_debut`, `annee_academique_fin`, `apprenti_email`, `apprenti_name`, `apprenti_prenom`, `programme`, `telephone`, `entreprise_id`, `ma_id`, `majeur_id`) VALUES
...
-- rendu
INSERT IGNORE INTO `rendu` (`rendu_id`, `commentaire`, `note_rendu`, `theme`, `type_rendu`) VALUES
...
-- soutenance
INSERT IGNORE INTO `soutenance` (`soutenance_id`, `commentaires`, `date`, `note`) VALUES
...
-- evaluation_ecole
INSERT IGNORE INTO `evaluation_ecole` (`evaluation_ecole_id`, `feedback_enseignant`, `remarque`, `apprenti_id`, `rendu_id`, `soutenance_id`) VALUES
...
-- mission
INSERT IGNORE INTO `mission` (`mission_id`, `commentaires`, `metier_cible`, `mot_cle`, `apprenti_id`, `entreprise_id`, `ma_id`) VALUES
...
-- visite
INSERT IGNORE INTO `visite` (`visite_id`, `commentaires`, `format`, `visite_date`) VALUES
